...
public class Messages extends NLS {
    ...
    public static String CloneInputDialog_2;
    ...
    public static String CommitDialog_8;

    public static String CommitDialog_9;
    ...
    public static String SwitchBranchDialog_2;
